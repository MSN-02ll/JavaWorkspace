...
public class Run {
	...
	public static void main(String[] args) {
		 ...
		 *  
		 * HashSet : 중복을 허용하지 않고, 
		 * 			"빠르게" 저장 및 조회가 가능한 자료구조.
		 * LinkedHashSet : 중복을 허용하지 않지만,
		 * TreeSet : 중복을 허용하지 않지만, 
		 * 			오름차순정렬을 지원.
		 * */
		...
		hs2.add(new Student("공유", 40, 100));
		hs2.add(new Student("홍길동", 24, 46));
		hs2.add(new Student("김갑생", 26, 49));
		
		System.out.println(hs2);
		System.out.println(hs2.size());
		Student s1 = new Student("박영우",30,10);
		Student s2 = new Student("박영우",30,10);
		...
		// 2.Iterator를 통한 반복
		// - List 계열과 Set계열에서는 iterator를 직접 구현하였기 때문에 
