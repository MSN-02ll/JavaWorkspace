...
public class Run {
	...
	public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
		/*
		 * Class - 객체를 만들기 위한 설계도(class)를 변환
	...
	public void test1() throws ClassNotFoundException, InstantiationException, IllegalAccessException {
		...
		Class c1 = b.getClass(); // Book클래스의 설게정보(.class파일 참조)
		 ...
		 * Class클래스를 이용하여 클래스의 정보를 가져오고, 생성자나 메서드를 
		 * 활용하여 객체를 생성하고, 메소드를 호출하는 방식의 프로그래밍
		 * 
		 * 보통 프로그램이 실행중일때, 객체의 타입을 직접 알 수 없는 경우 Class를 통해 객체를 생성하고,
		 * 객체내부의 메타데이터를 수집하기 위해 사용한다.
		 * 
